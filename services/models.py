...
class RevolvingDoor(models.Model):
    ...
    fixed_glass_no = models.CharField(max_length=20,verbose_name='Sabit Cam Sayısı')
    moving_glass_no = models.CharField(max_length=100,verbose_name='Hareketli Cam Sayısı')
